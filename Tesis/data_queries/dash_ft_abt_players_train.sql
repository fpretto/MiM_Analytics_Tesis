...
grouped_players_team AS(
	...
	GROUP BY player_id, stats_players.team_id, team_name, team_country
...
-- ABT
DROP TABLE IF EXISTS fdm.dash_ft_abt_players_train;
CREATE TABLE fdm.dash_ft_abt_players_train AS (
SELECT
